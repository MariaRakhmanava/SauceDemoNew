...
public interface iTestConstants {
    ...
    String USERNAME_REQUIRED_ERROR_MESSAGE_TEXT = "Epic sadface: Username is required";
    String PASSWORD_REQUIRED_ERROR_MESSAGE_TEXT = "Epic sadface: Password is required";
    String NO_MATCHES_ERROR_MESSAGE_TEXT = "Epic sadface: Username and password do not match any user in this service";
